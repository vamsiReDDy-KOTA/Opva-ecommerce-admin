...
export const ColorForm: React.FC<ColorFormProps> = ({
    ...
    const title = initalDate ? "Edit color" : " Create color";
    const description = initalDate ? "Edit a color" : " Add a new color";
    const toastMessage = initalDate ? "color updated" : "color created";
