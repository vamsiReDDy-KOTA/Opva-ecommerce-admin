...
export const SizeForm: React.FC<SizeFormProps> = ({
    ...
    const title = initalDate ? "Edit size" : " Create size";
    const description = initalDate ? "Edit a size" : " Add a new size";
    const toastMessage = initalDate ? "Size updated" : "Size created";
